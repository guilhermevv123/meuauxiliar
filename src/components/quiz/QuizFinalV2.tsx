  ...
  return (
    <div className="flex flex-col items-center w-full max-w-md mx-auto min-h-[80vh] px-4 py-8 bg-background text-foreground space-y-12">
        ...
        <div className="w-full space-y-8">
            <div className="bg-primary/5 border border-primary/20 rounded-3xl p-8 text-center space-y-4 relative overflow-hidden">
                <div className="absolute top-0 right-0 p-3">
                    <Star className="w-6 h-6 text-primary fill-primary opacity-20" />
                </div>
                
                <div className="space-y-1">
                    <p className="text-muted-foreground line-through text-sm">De R$ 197,00 (Anual)</p>
                    <p className="text-5xl font-black text-white tracking-tight">12x R$ 12,25</p>
                ...
                <div className="flex flex-col gap-2 pt-4">
                    <Button 
                        ...
                        className="w-full py-8 text-xl font-bold bg-primary hover:bg-primary/90 text-primary-foreground rounded-2xl shadow-glow"
                    >
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3 p-4 bg-white/5 rounded-2xl border border-white/10">
                    ...
                    <span className="text-[10px] font-bold uppercase leading-tight">Compra Segura SSL</span>
                </div>
                <div className="flex items-center gap-3 p-4 bg-white/5 rounded-2xl border border-white/10">
                    <Lock className="w-5 h-5 text-primary" />
                    <span className="text-[10px] font-bold uppercase leading-tight">Dados Protegidos</span>
                </div>
            </div>
