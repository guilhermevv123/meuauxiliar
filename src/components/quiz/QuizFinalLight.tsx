    ...
    <div className="flex flex-col items-center w-full max-w-md mx-auto min-h-[80vh] px-4 py-8 bg-transparent text-slate-900 space-y-12">
        <div className="text-center space-y-4">
            ...
            <h1 className="text-3xl font-black leading-tight text-slate-900">
                Parabéns! Você liberou o preço de <span className="text-primary italic">12x R$ 5,90</span>.
            </h1>
        ...
        <div className="w-full space-y-8">
            <div className="bg-white border border-primary/20 rounded-3xl p-8 text-center space-y-4 relative overflow-hidden shadow-xl">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-5xl font-black text-slate-900 tracking-tight">12x R$ 5,90</p>
                    <p className="text-primary font-bold text-xs uppercase tracking-widest">Cobrado 1 vez ao ano (R$ 70,80)</p>
                </div>
                ...
                <div className="flex flex-col gap-2 pt-4">
                    <Button 
                        ...
                        onClick={() => {
                            ...
                            if (window.fbq) window.fbq('track', 'AddToCart', { value: 70.80, currency: 'BRL', content_name: 'Plano Anual Desconto' }, { eventID: eventId });
                            // CAPI
                            import('@/lib/meta-capi').then(({ sendCapiEvent }) => {
                                sendCapiEvent({
                                    ...
                                    customData: { value: 70.80, currency: 'BRL', content_name: 'Plano Anual Desconto' }
                                });
                            });
