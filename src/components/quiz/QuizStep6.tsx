  ...
  return (
    <div className="flex flex-col items-center w-full max-w-md mx-auto min-h-[80vh] px-4 py-8 bg-background text-foreground">
        ...
        <div className="grid grid-cols-2 gap-4 w-full mb-8">
            ...
            <div className="bg-card hover:bg-secondary/50 p-4 rounded-xl border border-border flex flex-col items-center text-center shadow-luxury transition-all hover:scale-105">
             ...
             <div className="bg-card hover:bg-secondary/50 p-4 rounded-xl border border-border flex flex-col items-center text-center shadow-luxury transition-all hover:scale-105">
                ...
                <h3 className="font-bold text-sm mb-1">Pare De Só Economizar</h3>
                <p className="text-xs text-muted-foreground">Participe dos nossos desafios com recompensas <strong>onde você pode ganhar até R$ 4.000 / mês.</strong></p>
            </div>
        </div>
        ...
        <div className="text-center space-y-4 mb-8">
            ...
            <p className="text-sm px-4 font-bold">Não só registrar gastos, a FINK AI é o meio para você transformar sua realidade financeira.</p>
        </div>
