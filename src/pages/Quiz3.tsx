...
import { Quiz3Simulation } from "@/components/quiz/Quiz3Simulation";
import { Quiz3Features } from "@/components/quiz/Quiz3Features";
...
import { QuizStep7 } from "@/components/quiz/QuizStep7"; // The Offer
                ...
                >
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3 text-left max-w-xs mx-auto">
                            {["Calculando economia potencial", "Verificando desconto vitalício", "Gerando plano personalizado"].map((text, idx) => (
                                <motion.div 
                                    key={idx}
