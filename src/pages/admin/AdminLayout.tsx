...
import { LayoutDashboard, Users, ChartBar, Wallet, PercentCircle, LogOut, Menu, ShoppingCart, Zap, UserPlus } from "lucide-react";
  ...
  return (
    <div className="flex flex-col h-full">
        ...
        <nav className="space-y-2 px-4 flex-1">
          ...
          <NavItem to="/admin/new-users" icon={UserPlus} label="Novos Usuários" onClick={onClose} />
